...
public class HomePage {
    ...
    @FindBy(css = "input[type='submit']") public WebElement openNewAccountButton;
    ...
    @FindBy(css = "input[value='Transfer']") public WebElement transferButton;
//  @FindBy(css = "div[id='rightPanel'] div div form div:nth-child(4) input") public WebElement transferButton;
    ...
    private void waitForElementClickable(WebElement element) throws Error{
    ...
    public String getAccountBalance(){
        waitForVisibility(mainAccountBalance);
